...
const difficulties = {
    ...
    { question: "ما هو اسم اليوم الذي يأتي بعد الأربعاء؟", answer: "الخميس" },
    { question: "كم عدد أيام الأسبوع؟", answer: "7" },
    { question: "ما هو لون الشمس؟", answer: "أصفر" },
    { question: "ما هو عكس كلمة 'كبير'؟", answer: "صغير" },
    { question: "كم عدد أرجل القطة؟", answer: "4" },
    { question: "ما هو الشهر الذي يأتي بعد يناير؟", answer: "فبراير" },
    { question: "ما هو اسم الكوكب الذي نعيش عليه؟", answer: "الأرض" },
    { question: "ما هو الحيوان الذي يقول موو؟", answer: "البقرة" },
    { question: "ما اسم الحيوان الذي يحب الجزر؟", answer: "الأرنب" },
    { question: "ما هو صوت القطة؟", answer: "مواء" },
    { question: "ما هو الشيء الذي نشربه كل يوم؟", answer: "الماء" },
    { question: "ما هو لون العشب؟", answer: "أخضر" },
    { question: "كم أصبع في اليد الواحدة؟", answer: "5" },
    { question: "ما هو الحيوان الذي ينام في الشتاء؟", answer: "الدب" },
    { question: "كم عدد العيون عند الإنسان؟", answer: "2" },
    { question: "ما هو الشيء الذي نقرأ منه؟", answer: "الكتاب" },
    { question: "ما اسم أداة الكتابة؟", answer: "القلم" },
    { question: "ما هو عدد أصابع القدم الواحدة؟", answer: "5" },
    { question: "ما هو الحيوان الذي يصدر صوت نقيق؟", answer: "الضفدع" },
    { question: "ما هو الشيء الذي نستخدمه لنأكل الطعام؟", answer: "الملعقة" },
    { question: "ما هو لون الحليب؟", answer: "أبيض" },
    { question: "كم عدد عجلات الدراجة؟", answer: "2" },
    { question: "أين ننام في الليل؟", answer: "السرير" },
    { question: "ما اسم الطائر الذي لا يطير؟", answer: "النعامة" },
    { question: "ما هو الحيوان الذي يزأر؟", answer: "الأسد" },
    { question: "ما اسم الشهر الأول من السنة؟", answer: "يناير" },
    ...
    { question: "ما هو اليوم الذي يأتي بعد الأحد؟", answer: "الاثنين" },
    { question: "ما هو الشيء الذي نسمع من خلاله؟", answer: "الأذن" },
    { question: "ما اسم المكان الذي نذهب إليه لشراء الطعام؟", answer: "السوبرماركت" },
    { question: "ما هو الشيء الذي نلبسه في أقدامنا؟", answer: "الحذاء" },
    { question: "ما هو الشيء الذي نضعه على الرأس للحماية من الشمس؟", answer: "القبعة" },
    ...
    { question: "أين نذهب عندما نمرض؟", answer: "المستشفى" },
    { question: "ما هو الحيوان الذي يقول 'نعامة'؟", answer: "النعامة" },
    { question: "كم عين للإنسان؟", answer: "2" },
    { question: "ما هو الشيء الذي نستخدمه لنشرب الماء؟", answer: "الكوب" }
    ],
    medium: [
       {
  question: "ما هي عاصمة أندونيسيا؟", answer: "جاكرتا" },
{ question: "ما هو الغاز الذي تمتصه النباتات من الجو؟", answer: "ثاني أكسيد الكربون" },
{ question: "ما هي أكبر قارة في العالم؟", answer: "آسيا" },
{ question: "كم عدد الأحرف في اللغة الإنجليزية؟", answer: "26" },
...
{ question: "ما هو الحيوان الذي يُعرف بسفينة الصحراء؟", answer: "الجمل" },
...
{ question: "ما هو اسم العملية التي يتم فيها تحويل الماء إلى بخار؟", answer: "التبخر" },
{ question: "ما هي اللغة الرسمية في اليابان؟", answer: "اليابانية" },
{ question: "ما هو اسم الكوكب الأحمر؟", answer: "المريخ" },
{ question: "في أي قارة تقع الأرجنتين؟", answer: "أمريكا الجنوبية" },
{ question: "ما اسم البحر الذي يقع بين السعودية ومصر؟", answer: "البحر الأحمر" },
{ question: "ما هو أول حرف في الأبجدية؟", answer: "ألف" },
{ question: "ما هو الشيء الذي نأكله ونستطيع تقشيره؟", answer: "الموز" },
...
{ question: "كم إصبع في القدم الواحدة؟", answer: "5" },
{ question: "ما هو الحيوان الذي يبيض؟", answer: "الدجاجة" },
{ question: "ما هو الحيوان الذي يعيش في الماء وله زعانف؟", answer: "السمكة" },
{ question: "ما هو الشيء الذي تكتبه ولا تقرأه؟", answer: "الاسم" },
{ question: "ما هو الحيوان الذي يعيش في الصحراء؟", answer: "الجمل" },
{ question: "ما هو لون الحليب؟", answer: "أبيض" },
{ question: "ما اسم الخضار التي تبكينا عند تقطيعها؟", answer: "البصل" },
{ question: "ما هو الحيوان الذي له خرطوم؟", answer: "الفيل" },
{ question: "كم عدد أذني الإنسان؟", answer: "2" },
{ question: "ما هو الشيء الذي نكتبه في المدرسة؟", answer: "الواجب" },
{ question: "ما اسم الحشرة التي تصدر صوتاً في الليل؟", answer: "الصرصار" },
{ question: "ما هو لون الموز؟", answer: "أصفر" },
{ question: "في أي مكان نضع الطعام لنحفظه بارداً؟", answer: "الثلاجة" },
{ question: "ما هو اسم الجهاز الذي يعرض الصور في التلفاز؟", answer: "الشاشة" },
{ question: "ما هو اسم الشيء الذي نضعه في أرجلنا عند المشي؟", answer: "الحذاء" },
{ question: "ما هو عدد أجنحة الطائرة؟", answer: "2" }
    ],
    hard: [
        { question: "ما هو الرمز الكيميائي للذهب؟", answer: "Au" },
{ question: "من هو مؤسس علم الجبر؟", answer: "الخوارزمي" },
{ question: "ما هو اسم أكبر كويكب في النظام الشمسي؟", answer: "سيريس" },
{ question: "ما هي أصغر دولة في العالم؟", answer: "الفاتيكان" },
{ question: "من هو مؤلف كتاب 'الأمير'؟", answer: "نيقولا ميكافيلي" },
{ question: "ما هو العنصر الأكثر وفرة في الكون؟", answer: "الهيدروجين" },
{ question: "ما هو اسم أعمق نقطة في المحيطات؟", answer: "خندق ماريانا" },
{ question: "من هو مكتشف نظرية النسبية؟", answer: "ألبرت أينشتاين" },
{ question: "ما هو اسم أعلى قمة جبلية تحت الماء؟", answer: "ماونا كيا" },
{ question: "ما هو عدد العظام في جسم الإنسان البالغ؟", answer: "206" },
{ question: "ما اسم العالم الذي طور قانون الجاذبية؟", answer: "إسحاق نيوتن" },
{ question: "ما هو عدد الكواكب في النظام الشمسي؟", answer: "8" },
{ question: "ما هو أصل كلمة 'كيمياء'؟", answer: "الكلمة مشتقة من اللغة العربية (الكيمياء) واليونانية (كيميا)" },
{ question: "من هو مكتشف الدورة الدموية؟", answer: "ويليام هارفي" },
{ question: "ما هو الجهاز المسؤول عن إنتاج الأنسولين في الجسم؟", answer: "البنكرياس" },
{ question: "ما اسم المجرة التي تنتمي إليها الأرض؟", answer: "درب التبانة" },
{ question: "ما هو العنصر الذي رمزه الكيميائي Fe؟", answer: "الحديد" },
{ question: "من كتب كتاب 'الأصل'؟", answer: "دان براون" },
{ question: "ما اسم النظرية التي تفسر تطور الأنواع؟", answer: "نظرية التطور"},
{ question: "ما هو الغاز الذي يتكون منه معظم الغلاف الجوي للأرض؟", answer: "النيتروجين" },
{ question: "ما هو اسم أول قمر صناعي أُطلق إلى الفضاء؟", answer: "سبوتنك 1" },
{ question: "في أي سنة تأسست منظمة الأمم المتحدة؟", answer: "1945" },
{ question: "ما اسم العالم الذي اكتشف البنسلين؟", answer: "ألكسندر فليمنغ" },
{ question: "ما هو العنصر الكيميائي الذي رمزه Hg؟", answer: "الزئبق" },
{ question: "من هو أول من دار حول الأرض؟", answer: "يوري غاغارين" },
{ question: "ما هو اسم الأداة التي تقيس شدة الزلازل؟", answer: "مقياس ريختر" },
{ question: "في أي دولة تقع جامعة هارفارد؟", answer: "الولايات المتحدة الأمريكية" },
{ question: "ما اسم أول رواية في التاريخ؟", answer: "قصة جلجامش" },
{ question: "ما اسم القمر التابع لكوكب المريخ؟", answer: "فوبوس و ديموس" },
{ question: "ما اسم أكبر صحراء في العالم؟", answer: "الصحراء الكبرى" },
{ question: "من هو أول عالم وضع جدولاً دورياً للعناصر؟", answer: "ديميتري مندليف" },
{ question: "في أي سنة هبط الإنسان على سطح القمر لأول مرة؟", answer: "1969" },
{ question: "ما هو اسم أضخم عضلة في جسم الإنسان؟", answer: "عضلة الأرداف (الألوية الكبرى)" },
{ question: "ما اسم المادة المسؤولة عن نقل الأوكسجين في الدم؟", answer: "الهيموغلوبين" },
{ question: "من هو مؤلف كتاب 'الجمهورية'؟", answer: "أفلاطون" },
{ question: "ما اسم أكبر بركان نشط في العالم؟", answer: "ماونا لوا" },
{ question: "ما اسم أعمق بحيرة في العالم؟", answer: "بحيرة بايكال" },
{ question: "في أي قارة يقع جبل إيفرست؟", answer: "آسيا" },
{ question: "من هو مكتشف الإلكترون؟", answer: "جوزيف جون طومسون" },
{ question: "ما اسم العالم الذي وضع قوانين الحركة الثلاثة؟", answer: "إسحاق نيوتن" }
    ]
};
